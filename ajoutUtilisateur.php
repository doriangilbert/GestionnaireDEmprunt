...
<div class="d-flex justify-content-center align-items-center h-100 flex-column">
    ...
    <form>
        ...
        <div class="row mb-3 align-items-center">
            ...
            <input type="text" class="form-control col" id="inputMatricule" placeholder="XXXXX">
        </div>
        <div class="row mb-3 align-items-center">
        ...
        <div class="row mb-3 align-items-center">
            ...
            <input type="password" class="form-control col" id="inputMotDePasse" placeholder="XXXXX">
        </div>
        <div class="row mb-3 align-items-center">
